function mySignupPage()
{
    ...
    if(Email.value == "")
    {
        document.getElementById('userEmail').innerHTML = "* Email is empty";
        flag = 0;
    }
    ...
    if(password.value == "")
    {
        document.getElementById('userPasswordError').innerHTML = "*password cannot empty";
        flag = 0;
    }
    else
    {
    ...
    if (!checked) 
    {
        document.getElementById('checkboxError').innerHTML = "* select terms and privacy";
        flag = 0;
    }
    else
    {
